...
const projects: Project[] = [
  {
    ...
    images: ["https://i.imgur.com/gaqGPba.jpg", "https://i.imgur.com/s8LnZis.jpg", "https://i.imgur.com/xgo6miF.jpg"],
    tags: ["FIVEM", "MLO", "PAID"],
  },
  {
    id: 2,
...
function PlansContent() {
  const getPlansData = (): Plan[] => [
    ...
    },
    {
      ...
      features: t("premiumFeatures") as string[],
      popular: false,
      color: "from-yellow-500 to-yellow-600",
      buttonColor: "border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-black",
    },
    ...
    },
    {
      ...
      features: t("exclusiveFeatures") as string[],
      popular: false,
      color: "from-yellow-500 to-yellow-600",
      buttonColor: "border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-black",
    },
    {
      ...
      features: t("freelancerFeatures") as string[],
      popular: true,
      color: "from-yellow-500 to-yellow-600",
      buttonColor: "border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-black",
    },
